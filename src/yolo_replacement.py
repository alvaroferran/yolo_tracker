...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            if predicted_class == config["class_to_detect"]:
                box = out_boxes[i]
                score = out_scores[i]
                ...
                radius = 5
                color = (0, 0, 255)
                e_top = center_y - radius
                e_bottom = center_y + radius
                e_left = center_x - radius
                e_right = center_x + radius
                draw.ellipse([e_left, e_top, e_right, e_bottom], fill=color)
                del draw
